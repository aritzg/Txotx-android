...
public class SagardotegiDetailTabListener implements TabListener {
	...
	public SagardotegiDetailTabListener( Sagardotegi sagardotegi, int selectedTab, Activity activity){
